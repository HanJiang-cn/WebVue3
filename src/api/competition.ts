...
enum Api {
  ...
  reviewCompetition = '/competition/user/getUserCom'
}
...
function reviewCompetition(competitionId:number, userId:number): Promise<any> {
  return post(`/competition/user/getUserCom?competitionId=${competitionId}&userId=${userId}`)
}
export {
  addCompetition,
