...
<template>
    <div class="card">
        <div class="coming">
            ...
            <div class="add"><el-icon><List /></el-icon><span @click="add"><a href="#">添加到计划表中</a></span></div>
            <div class="start">
    ...
    <div class="contest_body">
        ...
        <div class="card_four">
              <div class="list">
                    ...
                    <div class="Result">
                       <el-pagination background layout="prev, pager, next" :total="total" size="small"  v-model:current-page="currentPage"  v-model:page-size="pageSize" @current-change="() => {}" @size-change="() => {}"/>
                    </div>
              </div>
        </div>
