  ...
  <div class="box">
    ...
    <div class="form">
      <el-form ref="formRef" style="max-width: 600px" :model="dynamicValidateForm" label-width="auto"
        class="demo-dynamic">
        <el-form-item prop="teachername" label="队伍名称"
          :rules="[{ required: true, message: '队伍名不能为空', trigger: 'blur' }]">
        ...
        <el-form-item v-for="(domain, index) in dynamicValidateForm.domains" :key="domain.key" :label="'队员' + index"
          :prop="'domains.' + index + '.value'" :rules="{ required: true, message: '不能为空', trigger: 'blur', }">
